        ...
        <div className="inner-container clearfix">
          ...
          <div className="top-right pull-right">
            <ul className="info-list">
              <li>
                <a href="contact.html">
                  <span className="icon icofont-location-pin"></span> P.O Box 2467 . PC 133 Al Khuwair
                </a>
              </li>
            </ul>
          </div>
      ...
      <div className="auto-container">
        <div className="inner-container clearfix">
          <div className="pull-left logo-box">
            <div className="logo">
              <a href={`${pathname === "/about-us" ? "/" : "/" }`} >
                <Image src="/images/logo.webp" width={153} height={80} alt="XOM Oman" title="" />
              </a>  
            </div>
          </div>
            ...
            <nav className="main-menu navbar-expand-md">
              ...
              <div className="navbar-collapse show clearfix" id="navbarSupportedContent">
                <ul className="navigation clearfix">
                  ...
                  <li><Link href={`${pathname === "/about-us" ? "/" : "#what_we_do"}`} >What We Do</Link></li>
                  <li><Link href={`${pathname === "/about-us" ? "/" : "#where_we_operate"}`}>Where We Operate</Link></li>
                  <li><Link href="about-us">About</Link></li>
                  <li><Link href={`${pathname === "/about-us" ? "/" : "#contact"}`}>Contact</Link></li>
                </ul>
              </div>
            </nav>
          </div>
    ...
    <div className="mobile-menu">
      ...
      <nav className="menu-box">
        <div className="nav-logo">
          <a href="#intro">
            <Image src="/images/logo.png" alt="" width={153} height={80} title="" />
          </a>
        </div>
